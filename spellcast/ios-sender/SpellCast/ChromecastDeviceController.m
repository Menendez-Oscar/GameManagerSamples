...
static NSString *const kReceiverAppID = @"E92ACE28";  //Replace with your app id
...
- (void)showError:(NSString *)errorDescription {
  ...
  // Clear the previous session. This prevents the app in getting into an auto-reconnection loop if
  // there was an error connecting to a specific device.
  [self clearPreviousSession];
}
